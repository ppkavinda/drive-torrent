        ...
        <div id="card-stats">
            ...
            <div class="col s12 m6 l3">
                ...
                <div class="card-content cyan white-text">
                    ...
                    <i class="material-icons">person_outline</i> New Users</p>
            ...
            <div class="col s12 m6 l3">
                ...
                <div class="card-content red accent-2 white-text">
                    <p class="card-stats-title">
                    <i class="material-icons">attach_money</i>Total Users</p>
            ...
            <div class="col s12 m6 l3">
                ...
                <div class="card-content teal accent-4 white-text">
                    <p class="card-stats-title">
                    <i class="material-icons">trending_up</i> Total Visits</p>
            ...
            <div class="col s12 m6 l3">
                ...
                <div class="card-content deep-orange accent-2 white-text">
                    <p class="card-stats-title">
                    <i class="material-icons">content_copy</i> Bounced Rate</p>
