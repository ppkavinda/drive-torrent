<template>
    <div class="container">
            ...
            <div class="col s8">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <p>{{movie.year}}</p><br>
                        <div class="row">
                            <div class="col s2" v-for="(tag, index) in movie.genres" :key="index">
                                <span class="new badge">{{tag}}</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col s2">
        ...
        <div class="row">
            <div class="col s12">
                <div class="card">
                    <iframe type="text/html" :src="'https://youtube.com/embed/'+movie.yt_trailer_code+'?autoplay=0'" frameborder="0" width="100%" height="360"></iframe>
                </div>
            </div>
        </div>
        <div class="card">
            <div class="row" v-for="(torrent, index) in movie.torrents" :key="index">
                <div class="col s4">
